        ...
        <div className="bg-hero p-10 w-2/5 border-8 border-gold">
            ...
            <div className="grid grid-cols-4 gap-10">
                <div className='flex flex-col items-center'>
                    <Image onClick={((e) => setRace('Elf'))} value="Elf"
                    className='hover:opacity-50 hover:cursor-pointer' src={Elf} alt='Elf' width={100} height={100} />
                    <p className='text-gold'>Elf</p>
                </div>
                <div className='flex flex-col items-center'>
                    ...
                    <p className='text-gold'>Tiefling</p>
                </div>
                <div className='flex flex-col items-center'>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <p className='text-gold'>Githyanki</p>
                </div>
                <div className='flex flex-col items-center'>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <p className='text-gold'>Half-Elf</p>
                </div>
                <div className='flex flex-col items-center'>
                    ...
                    <p className='text-gold'>Halfling</p>
                </div>
                <div className='flex flex-col items-center'>
                ...
                <div className='flex flex-col items-center'>
                    ...
                    <p className='text-gold'>Dragonborn</p>
                </div>
                <div className='flex flex-col items-center'>
                    ...
                    <p className='text-gold'>Half-Orc</p>
                </div>
